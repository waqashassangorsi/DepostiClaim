	...
	echo '<div class="theplus-panel-row">';
		echo '<div class="theplus-panel-col theplus-panel-col-35">';
			...
			echo '<div class="theplus-welcome-user-info theplus-p-20 theplus-mb-8">';
				...
				echo '</div>';
				echo '<div class="theplus-sec-subtitle theplus-text-white theplus-mt-8">'.esc_html__('Thanks for choosing The Plus Add ons for Elementor. We have collection of most amazing widgets & features to supercharge your Elementor.','tpebl').'</div>';
				echo '<div class="theplus-sec-border theplus-bg-white"></div>';
				echo '<ul class="theplus-panel-list">';
					echo '<li>'.esc_html__("100+ Total Powerful Widgets",'tpebl').'</li>';
					echo '<li>'.esc_html__("20+ Total Unique Features",'tpebl').'</li>';
