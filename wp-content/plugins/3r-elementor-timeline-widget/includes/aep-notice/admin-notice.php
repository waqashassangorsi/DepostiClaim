...
if( get_option( 'aep_tl_notice' ) != 'aep_tl_never_show' ) {
...
function aep_tl_notice_options() {
      ...
      <div class='notice aep-notice'>
        ...
        <div class="aep-notice-content">
			...
			Your small donation will help us in this COVID-19 situation. Or give me a five-star review of our motivation. Thanks.</p>
...
function aep_tl_never_show() {
      update_option( 'aep_tl_notice', 'aep_tl_never_show' );
}